...
<div class="student">
    ...
    <div class="student-details">
        ...
        <p> From: Assistant Prof. at New Horizons college of Engg. - To: Silizium Circuits. </p>
    </div>
</div>
...
<div class="student">
    ...
    <div class="student-details">
        ...
        <p> Graduated: July, 2024. </p>
        <p>From: NIE Mysuru, To: Synopsis Bengaluru. </p>
    </div>
</div>
...
<div class="student">
    ...
    <div class="student-details">
        ...
        <p> Graduated: July, 2024. </p>
        <p>From: Institute of Technical Education and research To: Research Scientist @ IIT Bhubaneshwar.</p>
    </div>
</div>
...
FET (CLIP-SGFET) based Accelerometer".</p>
        <p> Graduated: May, 2019. (Main advisor: Prof. Seena V , IIST) </p>
        <p>From: Rajagiri School of Engineering and Technology, Kochi To: Pursue PhD at IISc Bangalore.</p>
    </div>
</div>

### B.Tech students who have done projects under my supervision

- Mali Bhavesh Jitendra
- Krishan
- Samyak Sanjay Parakh
- Shreesh Singh
- Bondugula Pranav
- Vemuganti Anantha Sai Phanindra
- Nagavasavi Jeepalyam
- Arti Rawat
- Ganga K M (from NIE Mysuru)
- Likhita Peddi
- Abhishek Bhandari
- Dasari Shirisha (@IIST, Guides: Seena V and Naveen Kadayinti)
- Arunima Das (@IIST, Guides: Seena V and Naveen Kadayinti)
